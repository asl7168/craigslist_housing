...
#SBATCH --output=../outfiles/pittsburgh/pittsburgh.out    # Path for output must already exist
#SBATCH --error=../outfiles/pittsburgh/pittsburgh.err     # Path for errors must already exist
#SBATCH --job-name="initial pittsburgh scrape"       # Name of job
