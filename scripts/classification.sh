...
#SBATCH --job-name=classification_job ## When you run squeue -u  this is how you can identify the job
#SBATCH --output=/projects/p31502/projects/craigslist/scripts/outfiles/classification_output.log ## standard out and standard error goes to this file
