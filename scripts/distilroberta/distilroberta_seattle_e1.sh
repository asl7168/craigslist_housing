...
#SBATCH --output=../outfiles/distilroberta/seattle_e1_train.out # Path for output must already exist
#SBATCH --error=../outfiles/distilroberta/seattle_e1_train.err  # Path for error must already exist
#SBATCH --job-name="distilling seattle, single epoch"

module purge
cd /projects/p31502/projects/craigslist
source ./venv_craig_env/bin/activate
cd ./models/distilroberta
python distilroberta.py train seattle 1
